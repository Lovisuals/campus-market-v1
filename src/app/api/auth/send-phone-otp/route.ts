  ...
  try {
    ...
    const response = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: FROM_EMAIL,
        to: email,
        subject: 'Campus Market P2P - Phone Login Code',
        html: `
          <!DOCTYPE html>
          <html>
            <head>
              <style>
                ...
                .otp-code { font-size: 36px; font-weight: bold; color: #008069; text-align: center; padding: 20px; background: white; border-radius: 8px; letter-spacing: 12px; margin: 20px 0; font-family: monospace; }
                .phone { font-size: 18px; font-weight: bold; color: #006d59; text-align: center; margin: 10px 0; }
            ...
            <body>
              <div class="container">
                <div class="header">
                  ...
                  <p>Phone Login Verification</p>
                </div>
                <div class="content">
                  <p>Hello!</p>
                  <p>You requested to login with your phone number:</p>
